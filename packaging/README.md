...
# -> dist_installer\BedrockServerManager-1.0.2-Setup.exe
```
...
packaging/linux/build-appimage.sh 1.0.2
# -> BedrockServerManager-1.0.2-x86_64.AppImage
```
...
AppImage script default to `1.0.2` only when built outside CI).
